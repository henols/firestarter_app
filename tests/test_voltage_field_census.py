...
key; and roughly twenty more textual hits land across `tests/test_chip_resolver.py`,
`tests/test_eprom_database.py`, `tests/test_extra_chips_supplement.py`, `tests/
