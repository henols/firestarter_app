...
| `0x0D`      | `IC2_ALG_EE28C32P`  | `EEPROM_POLL`       | `configure_eeprom28c`   | 28/32-pin 5V EEPROM (28C-series, DQ7 polling); this family has **no erase operation at all** — the host clears the `FLAG_CAN_ERASE` advertisement for it (Phase 121 D-12); see `firestarter/doc/PROTOCOLS.md` §1.6 for the SDP model |
