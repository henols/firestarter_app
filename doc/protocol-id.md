...
| `0x0D`      | `IC2_ALG_EE28C32P`  | `EEPROM_POLL`       | `configure_eeprom28c`   | 28/32-pin 5V EEPROM (28C-series, DQ7 polling); as of Phase 153 (ERASE-03/ERASE-04) the family has a **standalone software chip erase**, and the host sets the `FLAG_CAN_ERASE` advertisement for all 84 chips in the bucket — **software-proven and unvalidated on silicon**; see `firestarter/doc/PROTOCOLS.md` §1.6 for the SDP and erase model |
