...
CATALOG: dict[int, MessageDef] = {
    ...
    0xBB: MessageDef(id=0xBB, name="MSG_ERR_PROTOCOL_NOT_IMPLEMENTED", severity=SEVERITY_ERROR, format="Protocol 0x%02x not implemented", params=(("u8", "hex_byte"),), param_bytes=1, wire_format="id_frame"),
