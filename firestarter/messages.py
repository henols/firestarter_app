...
MSG_INFO_CMD = 0x5D
MSG_INFO_SDP_UNLOCK = 0x5E
MSG_INFO_SDP_UNLOCK_DONE_US = 0x5F
MSG_INFO_SDP_LOCK = 0x60
MSG_INFO_SDP_LOCK_DONE_US = 0x61
MSG_INFO_PAGE_LOAD_WORST_US = 0x62
...
CATALOG: dict[int, MessageDef] = {
    ...
    0x5F: MessageDef(
        ...
        severity=SEVERITY_INFO,
        format="SDP unlock sequence emitted in %lu us; protection state is not readable",
        params=(("u32", "dec"),),
        param_bytes=4,
        wire_format="id_frame",
    ),
    0x60: MessageDef(
        id=0x60,
        name="MSG_INFO_SDP_LOCK",
        severity=SEVERITY_INFO,
        format="SDP lock: enabling write protection",
        params=(),
        param_bytes=0,
        wire_format="id_frame",
    ),
    ...
    0x62: MessageDef(
        id=0x62,
        name="MSG_INFO_PAGE_LOAD_WORST_US",
        severity=SEVERITY_INFO,
        format="Page load worst byte interval %lu us",
        params=(("u32", "dec"),),
        param_bytes=4,
        wire_format="id_frame",
    ),
    ...
    0x86: MessageDef(
        id=0x86,
        name="MSG_WARN_SDP_UNLOCK_SKIPPED",
        severity=SEVERITY_WARN,
        format="SDP unlock skipped -- write will not land on an SDP-protected part",
        params=(),
        param_bytes=0,
        wire_format="id_frame",
    ),
    0x87: MessageDef(
        id=0x87,
        name="MSG_WARN_SDP_TBLC_EXCEEDED",
        severity=SEVERITY_WARN,
        format="SDP unlock exceeded t_BLC budget: %lu us",
        params=(("u32", "dec"),),
        param_bytes=4,
        wire_format="id_frame",
    ),
    ...
    0xAE: MessageDef(
        id=0xAE,
        name="MSG_ERR_PULSE_TOO_WIDE",
        severity=SEVERITY_ERROR,
        format="Pulse width %lu us exceeds this protocol's per-byte program-energy budget",
        params=(("u32", "dec"),),
        param_bytes=4,
        wire_format="id_frame",
    ),
    ...
    0xBD: MessageDef(
        ...
        severity=SEVERITY_ERROR,
        format="Byte at 0x%06x failed to program within %d pulses",
    ...
    0xE1: MessageDef(
        ...
        severity=SEVERITY_DATA,
        format="Lock status probe: raw=0x%02X decode=%u",
        params=(("u8", "hex_byte"), ("u8", "dec")),
        param_bytes=2,
        wire_format="id_frame",
    ),
    0xE2: MessageDef(
...
DEBUG_CATALOG: dict[int, MessageDef] = {
    ...
    0x15: MessageDef(
        ...
        severity=SEVERITY_DATA,
        format="Pulse delay mismatch: expected %d, got %d",
        params=(("u8", "dec"), ("u8", "dec")),
        param_bytes=2,
        wire_format="id_frame",
    ),
