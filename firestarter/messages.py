...
DBG_PHYSICAL_HARDWARE_REVISION = 0x36
...
DEBUG_CATALOG: dict[int, MessageDef] = {
    ...
    0x36: MessageDef(id=0x36, name="DBG_PHYSICAL_HARDWARE_REVISION", severity=SEVERITY_DATA, format="Physical hardware revision: %u", params=(("u8", "dec"),), param_bytes=1, wire_format="id_frame"),
}
